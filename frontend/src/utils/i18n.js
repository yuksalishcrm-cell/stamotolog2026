...
export const TEXT = {
  uz: {
    appTitle: 'Stamotolog',
    appSubtitle: 'Mijozlar zanjiri dashboard',

    loginTitle: 'Stamotolog Mijozlar zanjiri',
    ...
    dashboard: 'Dashboard',
    dashboardSubtitle: 'Bemorlar va mijozlar zanjiri statistikasi',
    ...
    failed: 'Xato',
    completed: 'Keldi',
    recentFollowups: 'Yaqin mijozlar zanjiri',
    empty: 'Hozircha yo‘q',
    ...
    addVisit: '+ Yangi muolaja / mijozlar zanjiri',
    ...
    telegramConnectedText: 'Endi bu bemorga mijozlar zanjiri eslatmalari Telegram orqali yuboriladi.',
    visitsHistory: 'Muolajalar tarixi',
    followupHistory: 'Mijozlar zanjiri tarixi',
    noVisits: 'Hozircha muolaja yo‘q',
    treatmentMissing: 'Muolaja yozilmagan',

    followups: 'Mijozlar zanjiri',
  ...
  ru: {
    appTitle: 'Stamotolog',
    appSubtitle: 'Панель цепочки клиентов',

    loginTitle: 'Stamotolog: цепочка клиентов',
    ...
    dashboard: 'Панель',
    dashboardSubtitle: 'Статистика пациентов и цепочки клиентов',
    ...
    failed: 'Ошибка',
    completed: 'Завершено',
    recentFollowups: 'Ближайшая цепочка клиентов',
    ...
    addVisit: '+ Новое лечение / цепочка клиентов',
    ...
    telegramConnectedText: 'Теперь этому пациенту будут отправляться напоминания по цепочке клиентов через Telegram.',
    visitsHistory: 'История лечения',
    followupHistory: 'История цепочки клиентов',
    noVisits: 'Лечений пока нет',
    treatmentMissing: 'Лечение не указано',

    followups: 'Цепочка клиентов',
